...
- safezone: `Layer` - Returns the safezone-layer that covers 90% of the view. Safezones are widely used in TV-applications to prevent clipping of content. You should usually add children to this property. For example: `parent: myView.safezone`.
